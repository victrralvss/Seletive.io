...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('empresas', '0003_tecnologias_empresa_logo_empresa_tecnologias'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tecnologias_dominadas', models.ManyToManyField(to='empresas.tecnologias')),
                ('tecnologias_etudar', models.ManyToManyField(related_name='estudar', to='empresas.tecnologias')),
            ],
        ),
    ]
